...
static const struct CachedPower kCachedPowers[] = {
...
#define EXPONENT_MASK DOUBLE_CONVERSION_UINT64_2PART_C(0x7FF00000, 00000000)
#define SIGNIFICAND_MASK DOUBLE_CONVERSION_UINT64_2PART_C(0x000FFFFF, FFFFFFFF)

#define GET_EXPONENT(x) ((x) & EXPONENT_MASK)
#define GET_SIGNIFICAND(x) ((x) & SIGNIFICAND_MASK)
#define IS_DENORMAL(x) (((x) & SIGNIFICAND_MASK) == 0)

#define DIY_FP_SAGNIFICAND_SIZE 64
#define LOG_10_2 0.30102999566398114

#define DENORMAL_EXPONENT -1074
#define EXPONENT_BIAS 1075
#define HIDDEN_BIT DOUBLE_CONVERSION_UINT64_2PART_C(0x00100000, 00000000)

#define MINIMAL_TARGET_EXPONENT -60
#define MAXIMAL_TARGET_EXPONENT -32

#define CACHED_POWER_OFFSET 348
#define DECIMAL_EXPONENT_DISTANCE 8
